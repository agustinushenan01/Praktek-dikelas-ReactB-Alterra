...
function ContentCreateProduct() {
    return (
        <div className="container mx-auto flex flex-col justify-center px-5 sm:px-20">
            <div className="flex flex-col justify-center text-center text-figmagray-900 mb-9 sm:mb-18">
            <svg
                    width={72}
                    height={57}
                    viewBox="0 0 72 57"
                    ...
                    className="mx-auto mt-6 sm:mt-12 mb-6 sm:mb-12"
                >
                ...
                <h1 className="font-medium text-2xl sm:text-3xl pb-3 sm:pb-5">Create Product</h1>
                <p className="sm:text-xl">Below is an example form built entirely with Bootstrap’s form controls. Each required
                    form group has a validation state that can be triggered by attempting to submit the form without
                    completing it.</p>
            </div>
            <div className="flex flex-col justify-center sm:w-3/4 sm:mx-auto text-figmagray-900">
                <h2 className="font-medium text-lg sm:text-xl mb-6">Detail Product</h2>
